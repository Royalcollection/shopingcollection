...
const ORDER_CONFIG = {
  ...
  instagramUrl: "https://www.instagram.com/royalcollection.inn/"
};
...
document.getElementById("paymentForm").addEventListener("submit",async e=>{
  ...
  const connection=await submitOrderToGoogle(order);
  order.syncedToGoogle=connection.connected;
  ...
  const wa=document.querySelector("#orderSuccess a");
  if(wa){
